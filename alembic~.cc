//------------------------------------------------------------------------------
// Pd class `alembic~` generated by faust2pdex
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
#define DSP_CLASS_NAME "alembic~"
#define DSP_SETUP alembic_tilde_setup
#define DSP_MAINSIGNALIN 1
#define DSP_NUM_CONTROLS 5
#define DSP_NUM_INPUTS 1
#define DSP_NUM_OUTPUTS 1
#define DSP_CONTROLS(F) \
    F("Bass", Bass, "Bass", true, true, -1, 0, 1) \
    F("Input", Input, "Input", true, true, -1, 0, 1) \
    F("Middle", Middle, "Middle", true, true, -1, 0, 1) \
    F("Treble", Treble, "Treble", true, true, -1, 0, 1) \
    F("Volume", Volume, "Volume", true, true, -1, 0, 1)
//------------------------------------------------------------------------------
