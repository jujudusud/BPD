//------------------------------------------------------------------------------
// Pd class `bddi-p11~` generated by faust2pdex
//------------------------------------------------------------------------------
...
#define DSP_CC_FILENAME "./dsp/bddi-p11.cc"

//------------------------------------------------------------------------------
// Static definitions from generator
//------------------------------------------------------------------------------
#define DSP_CLASS_NAME "bddi-p11~"
#define DSP_SETUP setup_bddi0x2dp11_tilde
#define DSP_MAINSIGNALIN 1
#define DSP_NUM_CONTROLS 2
#define DSP_NUM_INPUTS 1
#define DSP_NUM_OUTPUTS 1
#define DSP_CONTROLS(F) \
    F("PR24v", PR24v, "PR24v", true, true, -1, 0, 1) \
    F("PR41v", PR41v, "PR41v", true, true, -1, 0, 1)
//------------------------------------------------------------------------------
