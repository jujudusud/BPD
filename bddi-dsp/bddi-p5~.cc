//------------------------------------------------------------------------------
// Pd class `bddi-p5~` generated by faust2pdex
//------------------------------------------------------------------------------
...
#define DSP_CC_FILENAME "./dsp/bddi-p5.cc"

//------------------------------------------------------------------------------
// Static definitions from generator
//------------------------------------------------------------------------------
#define DSP_CLASS_NAME "bddi-p5~"
#define DSP_SETUP setup_bddi0x2dp5_tilde
#define DSP_MAINSIGNALIN 1
#define DSP_NUM_CONTROLS 1
#define DSP_NUM_INPUTS 1
#define DSP_NUM_OUTPUTS 1
#define DSP_CONTROLS(F) \
    F("PR20v", PR20v, "PR20v", true, true, -1, 0, 1)
//------------------------------------------------------------------------------
